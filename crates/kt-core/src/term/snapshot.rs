...
pub struct SnapshotCell {
    ...
    pub bg: Rgb,
    pub attrs: CellAttrs,
    /// True when the foreground was the terminal's unstyled default color.
    /// The UI may adapt this color to the application theme without changing
    /// explicit ANSI, indexed, or truecolor output.
    pub default_fg: bool,
}
