...
pub struct DialogText {
    ...
    pub vault_unlock_title: &'static str,
    pub vault_unlock_body: &'static str,
    pub vault_master_password: &'static str,
    pub vault_master_password_placeholder: &'static str,
    pub vault_unlock: &'static str,
    pub vault_unlock_required: &'static str,
    pub vault_unlock_failed: &'static str,
    pub vault_save_failed: &'static str,
    pub vault_password_saved: &'static str,
    pub vault_password_not_saved: &'static str,
