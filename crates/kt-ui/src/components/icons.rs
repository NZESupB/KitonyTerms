...
fn IconPath(name: &'static str) -> Element {
    match name {
        ...
        "eye" => rsx! {
            path { d: "M2 12S5.5 5 12 5S22 12 22 12S18.5 19 12 19S2 12 2 12" }
            path { d: "M12 9A3 3 0 1 0 12 15A3 3 0 1 0 12 9" }
        },
        "eye-off" => rsx! {
            path { d: "M3 3L21 21" }
            path { d: "M10.6 10.6A2 2 0 0 0 13.4 13.4" }
            path { d: "M9.9 5.2A10.8 10.8 0 0 1 12 5C18.5 5 22 12 22 12A17.7 17.7 0 0 1 18.7 16.3" }
            path { d: "M6.6 6.6C3.7 8.5 2 12 2 12S5.5 19 12 19A10.8 10.8 0 0 0 15.4 18.4" }
        },
        "add" => rsx! {
            path { d: "M12 5V19" }
            path { d: "M5 12H19" }
